...
xhr.open("POST", "http://127.0.0.1:3001/API/Usuarios/Listar");
...
xhr.open("POST", "http://127.0.0.1:3001/API/Usuarios/Guardar");
  ...
  swal({
      ...
      if (isConfirm) {
        swal({
          ...
          xhr.open("POST", "http://127.0.0.1:3001/API/Usuarios/Eliminar");
          xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
...
var cargarId = function(id){
  ...
  xhr.open("POST", "http://127.0.0.1:3001/API/Usuarios/cargarId");
  xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
...
xhr.open("POST", "http://127.0.0.1:3001/API/Usuarios/Modificar");
xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
